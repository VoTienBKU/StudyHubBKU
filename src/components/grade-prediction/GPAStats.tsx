    ...
    <div className="grid grid-cols-1 sm:grid-cols-4 gap-6 mb-8">
      <Card>
        <CardContent className="p-6 text-center">
          ...
          <h3 className="text-2xl font-bold text-foreground">{gpa10} / 10</h3>
      ...
      <Card>
        <CardContent className="p-6 text-center">
          ...
          <h3 className="text-2xl font-bold text-foreground">{gpa4} / 4</h3>
      ...
      <Card>
        <CardContent className="p-6 text-center">
          ...
          <h3 className="text-2xl font-bold text-foreground">{totalSubjects}</h3>
